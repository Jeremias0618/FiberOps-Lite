...
<body>
<div class="container">    <h2><span class="material-icons" style="vertical-align:middle;">router</span> Consulta OLT Huawei</h2>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['valor_busqueda'])) {
        ...
        if ($row) {
            ...
            echo "</div>";
            echo "<h4 style='margin-bottom:0.7rem;'><span class='material-icons' style='vertical-align:middle;'>settings_ethernet</span> Consultas</h4>";            echo "<div class='snmp-btns'>";
